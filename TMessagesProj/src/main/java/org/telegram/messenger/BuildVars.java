...
public class BuildVars {
    ...
    // This fork does not expose local purchase entry points. Server-side premium state and limits remain unchanged.
    public static final boolean PAID_FEATURES_ENABLED = false;
    ...
    public static boolean isBetaApp() {
        if (betaApp == null) {
            betaApp = ApplicationLoader.applicationContext != null && BuildConfig.DEBUG_VERSION;
        }
        return betaApp;
    }
